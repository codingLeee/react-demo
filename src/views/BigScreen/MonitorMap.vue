  ...
  methods: {
    initmap() {
      ...
      _this.map.on("click", function(e) {
        ...
        map.flyTo({
          center: [104.06101014730666, 30.69375413710911],
          zoom: 15.0406377102522,
          bearing: -33.2953067681251,
          pitch: 68.019558821969,
          speed: 0.25
        });
    ...
    renderGeojson3D() {
      ...
      _this.map.on("click", "entity_layer", function(e) {
        ...
        // 根据经纬度获得要素
        // console.log( _this.map.queryRenderedFeatures([104.03657539918424,30.68370428596259], {
        //   layers: ["entity_layer"]
        // }));
      });

      // 添加贴图
      // _this.map.loadImage("~static/BigScreen/img/gao.png", function(error, image) {
